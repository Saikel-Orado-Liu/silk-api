...
/**
 * Test {@link BoltActionRepeatingFirearmItem}
 */
public final class BoltActionRepeatingFirearmItemTest extends BoltActionRepeatingFirearmItem {
	/**
	 * @param settings 物品设置
	 */
	...
	public ShootProjectilesComponent shootProjectiles() {
		return new ShootProjectilesComponent(false, 2, ShootProjectilesComponent.State.ALL);
	}
