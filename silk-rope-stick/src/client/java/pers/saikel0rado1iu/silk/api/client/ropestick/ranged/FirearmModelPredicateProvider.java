...
public interface FirearmModelPredicateProvider {
    ...
    static <T extends CrossbowLikeItem> void register(T firearm) {
        ModelPredicateProviderRegistry.register(firearm,
        ...
        ModelPredicateProviderRegistry.register(firearm,
                ...
                (stack, world, entity, seed) -> {
                    ...
                    return entity.getActiveItem() != stack
                            ...
                            stack.getMaxUseTime(entity) - entity.getItemUseTimeLeft() - 1);
                });
        ModelPredicateProviderRegistry.register(firearm,
        ...
        ModelPredicateProviderRegistry.register(firearm,
                ...
                (stack, world, entity, seed) -> {
                    ...
                    return stack
                            .getOrDefault(RANGED_WEAPON, RangedWeaponComponent.CROSSBOW)
