...
public record EffectiveItemSlotData(List<EquipmentSlot> slots) {
    /** 盔甲物品槽 */
    public final static EffectiveItemSlotData ARMOR = EffectiveItemSlotData
            .of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET);
    /** 手部物品槽 */
    public final static EffectiveItemSlotData HAND = EffectiveItemSlotData
            .of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND);
    /** 所有物品槽 */
    public final static EffectiveItemSlotData ALL = EffectiveItemSlotData.of();
    /** 有效物品槽数据的编解码器 */
    public static final Codec<EffectiveItemSlotData> CODEC = RecordCodecBuilder
            .create(builder -> builder
                    .group(EquipmentSlot.CODEC
                            .listOf()
                            .fieldOf("slots")
                            .forGetter(EffectiveItemSlotData::slots))
