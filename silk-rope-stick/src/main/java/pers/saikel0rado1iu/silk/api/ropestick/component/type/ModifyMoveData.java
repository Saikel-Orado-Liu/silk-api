...
public record ModifyMoveData(float moveSpeedMultiple) {
    ...
    /** 修改移动数据的编解码器 */
    public static final Codec<ModifyMoveData> CODEC = RecordCodecBuilder
            .create(builder -> builder
                    .group(Codec.FLOAT
                            .optionalFieldOf("move_speed_multiple", DEFAULT_SPEED_MULTIPLE)
                            .forGetter(ModifyMoveData::moveSpeedMultiple))
