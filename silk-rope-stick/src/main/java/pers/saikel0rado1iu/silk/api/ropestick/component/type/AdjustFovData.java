 ...
 * @since 1.1.2
 */
public record AdjustFovData(boolean onlyFirstPerson, Optional<Identifier> hudOverlay,
    ...
    /** 默认的调整视场角数据 */
    public static final AdjustFovData DEFAULT = AdjustFovData.create(false, null,
            false, DEFAULT_FOV_SCALING);
    /** 调整视场角数据的编解码器 */
    public static final Codec<AdjustFovData> CODEC = RecordCodecBuilder.create(builder -> builder
            .group(Codec.BOOL.optionalFieldOf("only_first_person", false)
                             .forGetter(AdjustFovData::onlyFirstPerson),
                    Identifier.CODEC.optionalFieldOf("hud_overlay")
                                    .forGetter(AdjustFovData::hudOverlay),
                    Codec.BOOL.optionalFieldOf("can_stretch_hud", false)
                              .forGetter(AdjustFovData::canStretchHud),
                    Codec.FLOAT.optionalFieldOf("fov_scaling", DEFAULT_FOV_SCALING)
                               .forGetter(AdjustFovData::fovScaling))
     ...
     * @return 调整视场角数据
     */
    public static AdjustFovData create(boolean onlyFirstPerson, @Nullable Identifier hudOverlay,
                                       boolean canStretchHud, float fovScaling) {
        return new AdjustFovData(onlyFirstPerson, Optional.ofNullable(hudOverlay),
                canStretchHud, fovScaling);
    }
