 ...
 * @since 1.1.2
 */
public record ModifyMoveWhileUseComponent(ModifyMoveComponent modifyMove) {
	public static final ModifyMoveWhileUseComponent DEFAULT = new ModifyMoveWhileUseComponent(ModifyMoveComponent.DEFAULT);
	public static final Codec<ModifyMoveWhileUseComponent> CODEC = RecordCodecBuilder.create(builder -> builder.group(
					ModifyMoveComponent.CODEC.optionalFieldOf("modify_move", ModifyMoveComponent.DEFAULT).forGetter(ModifyMoveWhileUseComponent::modifyMove))
