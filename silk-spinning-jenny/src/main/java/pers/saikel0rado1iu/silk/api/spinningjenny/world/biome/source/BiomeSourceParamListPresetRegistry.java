...
/**
 * <h2>{@link MultiNoiseBiomeSourceParameterList.Preset} 注册表</h2>
 ...
 * @since 1.0.0
 */
public interface BiomeSourceParamListPresetRegistry
        extends LaunchRegistrationProvider<MultiNoiseBiomeSourceParameterList.Preset> {
    /**
     * 预启动注册方法
     * <p>
     * 此方法方法一个预启动注册器，注册器注册返回注册对象
     *
     * @param preset 注册对象
     * @return 预启动注册器
     */
    static BiomeSourceParamListPresetRegistry.LaunchRegistrar registrar(
    ...
    /**
     * <h2>多重噪声生物群系源参数列表预设预启动注册器</h2>
     * 请使用
     * {@link
     * BiomeSourceParamListPresetRegistry#registrar(MultiNoiseBiomeSourceParameterList.Preset)} 注册
     *
     * @author <a href="https://github.com/Saikel-Orado-Liu">
     *         <img alt="author" src="https://avatars.githubusercontent.com/u/88531138?s=64&v=4">
     *         </a>
