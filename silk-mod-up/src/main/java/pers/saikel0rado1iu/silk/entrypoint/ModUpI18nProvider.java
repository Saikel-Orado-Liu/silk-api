...
import pers.saikel0rado1iu.silk.api.modup.*;
 ...
 * @since 0.1.0
 */
final class ModUpI18nProvider extends I18nModInfoProvider {
	static final ModUpI18nProvider EN_US = new ModUpI18nProvider("en_us",
			"Silk API：Mod ↑",
	...
	static final ModUpI18nProvider ZH_CN = new ModUpI18nProvider("zh_cn",
			"丝绸开发库：模组↑",
			"用于实现模组更新功能的子开发库。",
	...
	static final ModUpI18nProvider ZH_HK = new ModUpI18nProvider("zh_hk",
			"絲綢開發庫：模組↑",
			"用於實現模組更新功能嘅子開發庫。",
	...
	static final ModUpI18nProvider ZH_TW = new ModUpI18nProvider("zh_tw",
			"絲綢開發庫：模組↑",
			"用於實現模組更新功能的子開發庫。",
	...
	private ModUpI18nProvider(String langCode, String name, String summary, String description, String[] allText) {
