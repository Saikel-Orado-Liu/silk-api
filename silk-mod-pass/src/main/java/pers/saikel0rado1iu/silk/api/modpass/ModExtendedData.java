...
public interface ModExtendedData extends ModBasicData {
    ...
    default Collection<ModDependency> depends() {
        return mod().getMetadata()
                    .getDependencies()
                    .stream()
                    .filter(mod -> mod.getKind() == ModDependency.Kind.DEPENDS)
                    .toList();
    }
    ...
    default Collection<ModDependency> recommends() {
        return mod().getMetadata()
                    .getDependencies()
                    .stream()
                    .filter(mod -> mod.getKind() == ModDependency.Kind.RECOMMENDS)
                    .toList();
    }
    ...
    default Collection<ModDependency> suggests() {
        return mod().getMetadata()
                    .getDependencies()
                    .stream()
                    .filter(mod -> mod.getKind() == ModDependency.Kind.SUGGESTS)
                    .toList();
    }
    ...
    default Collection<ModDependency> breaks() {
        return mod().getMetadata()
                    .getDependencies()
                    .stream()
                    .filter(mod -> mod.getKind() == ModDependency.Kind.BREAKS)
                    .toList();
    }
    ...
    default Collection<ModDependency> conflicts() {
        return mod().getMetadata()
                    .getDependencies()
                    .stream()
                    .filter(mod -> mod.getKind() == ModDependency.Kind.CONFLICTS)
                    .toList();
    }
     ...
     */
    default Path jar() {
        return mod().getOrigin().getPaths().getFirst();
    }
